...
def shopSmart(orderList, fruitShops):
    ...
    """
    minimumTotalCost = fruitShops[0].getPriceOfOrder(orderList)
    fruitShopWithMinimumCost = fruitShops[0]
    for fruitShop in fruitShops:
        totalCost = fruitShop.getPriceOfOrder(orderList)

        if minimumTotalCost > totalCost:
    ...
    return fruitShopWithMinimumCost
